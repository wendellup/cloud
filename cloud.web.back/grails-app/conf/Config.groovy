...
log4j = {
    ...
    def logFilePath = "/apps/service/logs/push_sdk_back"
    ...
    appenders {
        ...
        def errorAppender = new DailyRollingFileAppender(name: "stacktrace",
                ...
                file: "${logFilePath}/push_sdk_back_Error.log", datePattern: "'.'yyyy-MM-dd")
        errorAppender.activateOptions()
        appender errorAppender

        appender new DailyRollingFileAppender(name: "serviceLog",
                layout: pattern(conversionPattern: "%-d{yyyy-MM-dd HH:mm:ss} %c{2} %m%n"),
                file: "${logFilePath}/push_sdk_back_service.log",
                datePattern: "'.'yyyy-MM-dd"
        )
    }
    root {
        info 'stdout', "serviceLog"
    }
