...
//                $('#gameIconinfo').attr("src", data.realGameIcon);
    ...
    function infoSubmit() {
        ...
        var url = "${createLink(controller: 'memory',action:'editSubmit')}";
...
<div class="matter_box">
    <h3 class="nopoint"><strong>推送管理&nbsp;&gt;&nbsp;游戏推送&nbsp;&gt;&nbsp;修改游戏推送</strong></h3>
<e:form id="fm">
	...
	<table class="table2">
        <tr>
            ...
            <td align="left">
                <input type="text" name="title" id="title" value="${memoryInfoVo.title}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源游戏标题'" onkeyup="checkLength(this, 28)">
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" name="description" id="description" value="${memoryInfoVo.description}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源游戏描述'" onkeyup="checkLength(this, 40)">
        ...
        <tr class="time_">
	   	...
	   	<tr>
	   		...
	   		<td class="tleft">
                <input type="text" name="linkUrl" id="linkUrl" value="${memoryInfoVo.linkUrl}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源游戏代码'" onkeyup="checkLength(this, 40)">
        ...
        <tr>
            ...
            <td class="tleft">
                <input type="text" name="ownName" id="ownName" value="${memoryInfoVo.ownName}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源渠道代码'" onkeyup="checkLength(this, 40)">
        ...
        <tr>
            ...
            <td class="tleft">
                <input type="text" name="gameName" id="gameName" value="${memoryInfoVo.gameName}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源游戏名称'" onkeyup="checkLength(this, 100)">
