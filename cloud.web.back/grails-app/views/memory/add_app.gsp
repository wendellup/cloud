...
//                    $.messager.alert('提示', data['msg'], 'ok');
    ...
    function openDialog() {
        showDialog({
            ...
            height: 500,
            title: "应用需求列表",
            url: '${createLink(controller: 'preMemory',action:'serviceMemoryList',params:[objType:2] )}'
        });
    }
...
<div class="matter_box">
    <h3 class="nopoint"><strong>推送管理&nbsp;&gt;&nbsp;应用推送&nbsp;&gt;&nbsp;新增应用推送</strong></h3>
    <e:form id="fm">
    %{--应用类型的objType设置为2--}%
	...
	<table class="table2">
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" name="title" id="title" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用标题'" onkeyup="checkLength(this, 28)">
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" name="description" id="description" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用描述'" onkeyup="checkLength(this, 40)">
        ...
        <tr>
            ...
            <td class="tleft">
                <input type="text" name="gameName" id="gameName" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用名称'" onkeyup="checkLength(this, 100)">
