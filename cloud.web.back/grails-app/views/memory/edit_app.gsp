...
//                        $("#dg").datagrid('reload');
                        location.href = '${createLink(controller: 'chargeIndex', action: 'indexApp')}';
                    });
...
<div class="matter_box">
    <h3 class="nopoint"><strong>推送管理&nbsp;&gt;&nbsp;应用推送&nbsp;&gt;&nbsp;修改应用推送</strong></h3>
<e:form id="fm">
	...
	<table class="table2">
        <tr>
            <td width="30%" align="right"><span class="wordred">*</span>资源应用标题：</td>
            <td align="left">
                <input type="text" name="title" id="title" value="${memoryInfoVo.title}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用标题'" onkeyup="checkLength(this, 28)">
                <span style="color:#FF0000;">营销语标题，14个中文以内</span>
            </td>
        </tr>
        <tr>
            <td align="right"><span class="wordred">*</span>资源应用描述：</td>
            <td align="left">
                <input type="text" name="description" id="description" value="${memoryInfoVo.description}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用描述'" onkeyup="checkLength(this, 40)">
        ...
        <tr class="time_">
	   	...
	   	<tr>
	   		<td width="30%" class="tright"><span class="wordred">*</span>资源应用代码：</td>
	   		<td class="tleft">
                <input type="text" name="linkUrl" id="linkUrl" value="${memoryInfoVo.linkUrl}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入应用ID'" onkeyup="checkLength(this, 40)">
                <span style="color:#FF0000;">应用ID</span>
	   		</td>
	   	</tr>
        <tr>
            <td width="30%" class="tright"><span class="wordred">*</span>资源应用名称：</td>
            <td class="tleft">
                <input type="text" name="gameName" id="gameName" value="${memoryInfoVo.gameName}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用名称'" onkeyup="checkLength(this, 100)">
                <span style="color:#FF0000;">50个中文以内</span>
            </td>
        </tr>
        <tr>
            <td class="tright"><span class="wordred">*</span>资源应用包体：</td>
            <td colspan="3">
        ...
        <tr>
            <td align="right" valign="top"><span class="wordred">*</span>资源应用图片：</td>
        ...
        <tr>
            <td width="30%" class="tright">应用主名称：</td>
            <td class="tleft">
        ...
        <tr>
            <td width="30%" class="tright">应用定价方式：</td>
            <td class="tleft">
        ...
        <tr>
            <td width="30%" class="tright">应用激活条件：</td>
            <td class="tleft">
        ...
        <tr>
            <td width="30%" class="tright">应用回收单价：</td>
            <td class="tleft">
