...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#dg').datagrid({
                url: '${createLink(controller: 'preMemory',action: 'list',params:[objType:3])}',
                columns: [
                    [
        ...
        function toAdd(){
            location.href = "${createLink(controller: 'preMemory',action:'addMemory',params:[type:1,objType:3])}";
        }
        ...
        function toEdit(){
            ...
            location.href = "${createLink(controller: 'preMemory',action:'editMemory')}?id=" + rows[0].id + "&type=1&objType=3";
        }
...
<e:layout fit="true">
    ...
    <h3 class="nopoint"><strong>需求录入管理&nbsp;&gt;&nbsp;广告需求管理</strong></h3>
    <e:form id="editForm">
