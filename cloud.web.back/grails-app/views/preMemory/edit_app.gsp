...
//                        $("#dg").datagrid('reload');
                        location.href = '${createLink(controller: 'chargeIndex', action: 'indexPreApp')}';
                    });
...
<div class="matter_box">
    <h3 class="nopoint"><strong>需求录入管理&nbsp;&gt;&nbsp;应用需求&nbsp;&gt;&nbsp;编辑应用需求</strong></h3>
<e:form id="fm">
	...
	<table class="table2">
        <tr>
            ...
            <td align="left">
                <input type="text" name="title" id="title" value="${preMemoryInfoVo.title}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用标题'" onkeyup="checkLength(this, 28)">
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" name="description" id="description" value="${preMemoryInfoVo.description}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用描述'" onkeyup="checkLength(this, 40)">
        ...
        <tr>
            ...
            <td class="tleft">
                <input type="text" name="linkUrl" id="linkUrl" value="${preMemoryInfoVo.linkUrl}" class="easyui-validatebox input_width200"
                       data-options="required:true,missingMessage:'请输入资源应用代码'" onkeyup="checkLength(this, 40)">
        ...
        <tr>
            ...
            <td class="tleft">
                <input type="text" name="gameName" id="gameName" value="${preMemoryInfoVo.gameName}" class="easyui-validatebox input_width200" data-options="required:true,missingMessage:'请输入资源应用名称'" onkeyup="checkLength(this, 100)">
            </td>
        </tr>
        <tr>
