...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#dg').datagrid({
                url: '${createLink(controller: 'preMemory',action: 'list',params:[objType:2])}',
                columns: [
                    [
                        ...
                        {field: 'packageName', title: '资源应用包名',width: 120,align:'center'},
        ...
        function toAdd(){
            location.href = "${createLink(controller: 'preMemory',action:'addMemory',params:[objType:2])}";
        }
        ...
        function toEdit(){
            ...
            location.href = "${createLink(controller: 'preMemory',action:'editMemory')}?id=" + rows[0].id + "&objType=2";
        }
...
<e:layout fit="true">
    ...
    <h3 class="nopoint"><strong>需求录入管理&nbsp;&gt;&nbsp;应用需求管理</strong></h3>
    <e:form id="editForm">
