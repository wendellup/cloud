...
<e:layout fit="true">
    <div class="matter_box">
        <h3 class="nopoint"><strong>需求录入管理&nbsp;&gt;&nbsp;应用需求&nbsp;&gt;&nbsp;新增应用需求</strong></h3>
        %{--<e:form id="fm">--}%
        <form id="fm">
            %{--游戏类型的objType设置为1--}%
                ...
                <tr>
                    ...
                    <td align="left">
                        <input type="text" name="title" id="title" class="easyui-validatebox input_width200"
                               data-options="required:true,missingMessage:'请输入资源应用标题'" onkeyup="checkLength(this, 28)">
                ...
                <tr>
                    ...
                    <td align="left">
                        <input type="text" name="description" id="description" class="easyui-validatebox input_width200"
                               data-options="required:true,missingMessage:'请输入资源应用描述'" onkeyup="checkLength(this, 40)">
                ...
                <tr>
                    ...
                    <td class="tleft">
                        <input type="text" name="gameName" id="gameName" class="easyui-validatebox input_width200"
                               data-options="required:true,missingMessage:'请输入资源应用名称'" onkeyup="checkLength(this, 100)">
